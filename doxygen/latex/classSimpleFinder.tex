...
\end{DoxyAuthor}
Simplified version of \hyperlink{classKFParticleFinder}{K\+F\+Particle\+Finder}. At the current moment it is developed to reconstruct the only decay channel\+: $\Lambda$ $\rightarrow$ $\pi^{-}$ $p^{+}$ 

\subsection{Member Function Documentation}
\index{Simple\+Finder@{Simple\+Finder}!Calculate\+Cos\+Momentum\+Sum@{Calculate\+Cos\+Momentum\+Sum}}
\index{Calculate\+Cos\+Momentum\+Sum@{Calculate\+Cos\+Momentum\+Sum}!Simple\+Finder@{Simple\+Finder}}
\subsubsection[{\texorpdfstring{Calculate\+Cos\+Momentum\+Sum(const std\+::array$<$ float, 8 $>$ \&pars1, const std\+::array$<$ float, 8 $>$ \&pars2) const }{CalculateCosMomentumSum(const std::array< float, 8 > &pars1, const std::array< float, 8 > &pars2) const }}]{\setlength{\rightskip}{0pt plus 5cm}float Simple\+Finder\+::\+Calculate\+Cos\+Momentum\+Sum (
\begin{DoxyParamCaption}
\item[{const std\+::array$<$ float, 8 $>$ \&}]{pars1, }
\item[{const std\+::array$<$ float, 8 $>$ \&}]{pars2}
\end{DoxyParamCaption}
) const\hspace{0.3cm}{\ttfamily [protected]}}\hypertarget{classSimpleFinder_adf804cbf61f06440529c38f703182030}{}\label{classSimpleFinder_adf804cbf61f06440529c38f703182030}


Calculates the cosine of the angle between daughter\textquotesingle{}s and mother\textquotesingle{}s momenta. 

Find cosine bitween daughter1 and mother momenta\index{Simple\+Finder@{Simple\+Finder}!Sort\+Tracks@{Sort\+Tracks}}
\index{Sort\+Tracks@{Sort\+Tracks}!Simple\+Finder@{Simple\+Finder}}
\subsubsection[{\texorpdfstring{Sort\+Tracks()}{SortTracks()}}]{\setlength{\rightskip}{0pt plus 5cm}void Simple\+Finder\+::\+Sort\+Tracks (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}\hypertarget{classSimpleFinder_aae81d5b2382f10072b91307af30ba4a2}{}\label{classSimpleFinder_aae81d5b2382f10072b91307af30ba4a2}
Sorts tracks\textquotesingle{} indices into 4 groups\+:~\newline
